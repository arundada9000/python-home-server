...
> **⚠️ Important:** This software is **not free to use**. It is proprietary — every use requires explicit written permission from the copyright holder. See [LICENSE](LICENSE).
...
> ⚠️ The server is not exposed to the public internet by default. Only devices on your Wi-Fi network can reach it. See [docs/NETWORK.md](docs/NETWORK.md) for details, and [docs/DEPLOYMENT.md](docs/DEPLOYMENT.md) if you ever want remote access (requires port forwarding / VPN — at your own risk).
...
├── Home/                      # ⚠️ Uploaded files live here (git-ignored)
...
├── config.json                # ⚠️ Server config (git-ignored, contains secret)
...
<div align="center">
<sub>Built with ❤️ in Nepal · © 2026 Arun Neupane / Sajilo Digital Pvt. Ltd.</sub>
</div>
