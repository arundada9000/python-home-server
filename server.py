...
class FileServerHandler(SimpleHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path.startswith("/api/"):
            ...
            elif path == "/api/portal_data": api_handlers.handle_portal_data(self, UPLOAD_ROOT, safe_join)
    ...
    def do_POST(self):
        try:
            ...
            elif parsed.path == "/api/portal_data": api_handlers.handle_portal_data(self, UPLOAD_ROOT, safe_join)
