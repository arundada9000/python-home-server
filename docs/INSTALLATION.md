...
> `config.json` contains a **secret admin key** and is git-ignored. Never
> commit it.
...
- **Run it properly** -> [Running the Server](RUNNING.md)
- **Connect your phone** -> [Networking & Domains](NETWORK.md)
- **Tune the config** -> [Configuration](CONFIGURATION.md)
