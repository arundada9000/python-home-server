...
|  |  - static files         |   |  :4143                 |   |
|  |  - REST API             |   |  - collab rooms        |   |
|  |  - file operations      |   |  - broadcast events    |   |
|  +------------+------------+   +-----------+------------+   |
|               |                          |                 |
|               v                          v                 |
|  +--------------------------------------------------+      |
...
|  |  Home/.collaborative/ -> canvases and scratchpads |      |
|  +--------------------------------------------------+      |
|                                                             |
...
- hidden folders filtered (unless show_hidden matches admin_key)
    |
JSON {path, items:[...]}
Browser <------------------------------- response -----------------/
```
